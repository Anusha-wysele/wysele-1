    ...
    <>
              ...
              <div className="flex flex-wrap gap-5 border-b border-white/10 pb-2 mb-5">
                {industries.map((item, index) => (
                  <button
                    ...
                    className={`relative text-sm capitalize tracking-normal transition-all duration-300 ${activeTab === index
                      ? "text-gray-900"
      ...
      <section className="w-full bg-white pt-4 md:pt-6 pb-8 md:pb-12 flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-sm md:text-base text-gray-600 mb-6 max-w-2xl font-light">
          discuss your cloud protection, operational monitoring, and vulnerability management requirements.
        </p>
